...
| 4 | [Building a Trigger-Contract App on Vela](docs/4_trigger-contract-app.md) | Step by step walk through the implementation of a WASM application that drives an external trigger contract |
